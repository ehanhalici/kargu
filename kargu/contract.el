...
;; Validates all data at module boundaries (type, structure, invariants)
;; so internal functions can execute with guaranteed correctness.
;; Pairs with `kargu/result' for Railway-Oriented error paths.
;;
;; Public:
;;   `kargu-contract-assert'
;;   `kargu-contract-validate'
;;   `kargu-contract-mode-p'
;;   `kargu-contract-role-p'
;;   `kargu-contract-content-p'
;;   `kargu-contract-tool-call-p'
;;   `kargu-contract-tool-calls-p'
;;   `kargu-contract-message-p'
;;   `kargu-contract-history-p'
;;   `kargu-contract-filepath-p'
;;   `kargu-contract-non-empty-string-p'
;;   `kargu-contract-url-p'
;;   `kargu-contract-tool-executor-p'
;;   `kargu-contract-prompt-p'
;;   `kargu-contract-callback-p'
;;   `kargu-contract-response-p'
...
;;;; Assertion & validation operators -------------------------------------
